...
public interface POReceiptRepository extends JpaRepository<POReceipt, Integer> {
	...
	@Query(value = "EXEC POReceiptInsert :GRNNo, :PID, :QuantityReceived, :QuantityReversed, :UnitCost, :OrigUnitCost, :InspectionCode, :IID, :StoreNo, :StoreBin, :InventoryCode, :LotNo, :IRID, :Created, :CreatedBy", 
		nativeQuery = true)
    POReceipt insertPOReceipt(@Param("GRNNo") String GRNNo, @Param("PID") Integer PID, @Param("QuantityReceived") BigDecimal QuantityReceived, @Param("QuantityReversed") BigDecimal QuantityReversed, @Param("UnitCost") BigDecimal UnitCost, @Param("OrigUnitCost") BigDecimal OrigUnitCost, 
							...
							@Param("IRID") Integer IRID, @Param("Created") Timestamp Created, @Param("CreatedBy") String CreatedBy
	);
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
	@Query(value = "EXEC POReceiptUpdate :ID, :GRNNo, :PID, :QuantityReceived, :QuantityReversed, :UnitCost, :OrigUnitCost, :InspectionCode, :IID, :StoreNo, :StoreBin, :InventoryCode, :LotNo, :IRID, :Created, :CreatedBy",  
		nativeQuery = true)
