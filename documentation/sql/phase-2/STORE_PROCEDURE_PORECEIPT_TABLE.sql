...
-- Alter POReceiptHeaderInsert
ALTER PROCEDURE POReceiptHeaderInsert  
    @GRNNo VARCHAR(20), @GRNDate DATETIME, @Status CHAR(1), @VendorID VARCHAR(12),  @ExchangeRate DECIMAL(18, 5), @TransportVia VARCHAR(30),
    @FreightBillNumber VARCHAR(30), @PackingListNumber VARCHAR(30), @GRNReference VARCHAR(12), @DiscountAmount DECIMAL(18, 2), @Remark VARCHAR(480), @GRNType CHAR(1),
    @InvoiceAmount DECIMAL(18, 2), @Hold CHAR(1), @Paid CHAR(1), @Posted CHAR(1), @Created DATETIME, @CreatedBy VARCHAR(8), 
    @Modified DATETIME, @ModifiedBy VARCHAR(8), @Accessed DATETIME, @AccessedBy VARCHAR(8), @CustomFormDate DATETIME, @CIFValue DECIMAL(18, 0),
    @CustomFormNo VARCHAR(20)
AS
BEGIN
...
-- Alter POReceiptHeaderUpdate
ALTER PROCEDURE POReceiptHeaderUpdate @ID INTEGER, 
    @GRNNo VARCHAR(20), @GRNDate DATETIME, @Status CHAR(1), @VendorID VARCHAR(12),  @ExchangeRate DECIMAL(18, 5), @TransportVia VARCHAR(30),
    @FreightBillNumber VARCHAR(30), @PackingListNumber VARCHAR(30), @GRNReference VARCHAR(12), @DiscountAmount DECIMAL(18, 2), @Remark VARCHAR(480), @GRNType CHAR(1),
    @InvoiceAmount DECIMAL(18, 2), @Hold CHAR(1), @Paid CHAR(1), @Posted CHAR(1), @Created DATETIME, @CreatedBy VARCHAR(8), 
    @Modified DATETIME, @ModifiedBy VARCHAR(8), @Accessed DATETIME, @AccessedBy VARCHAR(8), @CustomFormDate DATETIME, @CIFValue DECIMAL(18, 0),
