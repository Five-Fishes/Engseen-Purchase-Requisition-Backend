...
(
    ...
    RevisionLevel              varchar(2),
    MakeBuyCode                char        not null,
    ItemType                   char        not null,
    ItemStatus                 char        not null,
    LotTrace                   char        not null,
    Serialization              char        not null,
    OrderPolicy                char        not null,
    InspectionRequired         char        not null,
    Drawing                    varchar(30),
    ItemClassifications        char,
    Reference1                 varchar(30),
    Reference2                 varchar(30),
    Reference3                 varchar(30),
    Reference4                 varchar(30),
    ItemShippingWeight         decimal     not null,
    ItemShippingVolumn         decimal     not null,
    ItemPackageType            varchar(4),
    ItemPiecesPerPackage       decimal     not null,
    ItemGrossWeight            decimal,
    LotAssignmentPolicy        char,
    LotDefaultPolicy           char,
    FIFOInventoryPolicy        char,
    BackflushPolicy            char,
    AvailableCalendarDays      int,
    ShelfLifeCalendarDays      int,
    RetestCalendarDays         int,
    LastLot                    int,
    ...
    SerialNumberMask           varchar(20),
    DefaultSerialNumber        varchar(20),
    SerialNumberCounter        char,
    PlannerBuyer               varchar(8)  not null,
    RunLeadTime                int         not null,
    FixedLeadTime              int         not null,
    InspectionLeadTime         int         not null,
    PlanLeadTime               int,
    LotSizeDay                 int         not null,
    LotSizeQuantity            decimal     not null,
    SafetyStock                decimal     not null,
    MinimumLotSize             decimal     not null,
    MultipleLotSize            decimal     not null,
    PreferredStoreNo           varchar(4),
    PreferredStoreBin          varchar(12),
    ForecastCode               char        not null,
    ForecastPeriod             char        not null,
    ItemYieldFactor            int         not null,
    DecimalPrecisionCode       int         not null,
    LowLevelCode               int         not null,
    Remark1                    varchar(480),
    Remark2                    varchar(480),
    Remark3                    varchar(480),
    InventoryAccountNo         varchar(20) not null,
    SalesAccountNo             varchar(20) not null,
    COGSAccountNo              varchar(20) not null,
    AverageSellingPrice        decimal     not null,
    CostCode                   int         not null,
    MaterialCost               decimal     not null,
    LaborCost                  decimal     not null,
    VariableOverheadCost       decimal     not null,
    FixedOverheadCost          decimal     not null,
    TotalCost                  decimal     not null,
    RolledMaterialCost         decimal     not null,
    RolledLaborCost            decimal     not null,
    RolledVariableOverheadCost decimal     not null,
    RolledFixedOverheadCost    decimal     not null,
    TotalRolledCost            decimal     not null,
    StandardUnitPrice          decimal     not null,
    Label1                     varchar(50),
    Label2                     varchar(50),
    MinimumSellingPrice        decimal,
    LastSerialNumber           int,
